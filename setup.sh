...
# Get script path for self-deletion
get_script_path() {
...
show_completion() {
    ...
    echo -e "\n${BLUE}═══════════════════════════════════════════════════════════════${NC}"
    echo -e "${GREEN}Run the chat client manually:${NC}"
    echo -e "  ${YELLOW}python3 main.py${NC}  or  ${YELLOW}python main.py${NC}"
    echo -e "${BLUE}═══════════════════════════════════════════════════════════════${NC}\n"
}
...
main() {
    ...
    # Delete setup.sh
    print_info "Deleting setup script..."
    self_delete
}
